...
@section('title')
    Marcas - Panel de Administración
@endsection
                        ...
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>{{ $marca->name }}</td>
                                    <td>
                                        <a class="btn btn-success text-white" href="{{ route('admin.marcas.edit', $marca->id) }}">Editar</a>
                                        <form action="{{ route('admin.marcas.destroy', $marca->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger text-white" onclick="return confirm('¿Estás seguro de eliminar esta marca?')">Eliminar</button>
                                        </form>
                                    </td>
                                </tr>
                               @endforeach
